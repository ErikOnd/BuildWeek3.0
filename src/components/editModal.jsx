...
const EditModal = ({handleClose2,show2}) => {
...
const ons=()=>{
 ...
 const work=()=>{
   if(working===true){
    ...
    return (  
        <Modal show={show2} onHide={handleClose2} dialogClassName="positionModal d-flex" contentClassName="modal-height">
    ...
    <br /> <br />
        ...
        <Modal.Footer>
          ...
          <Button className="first button" onClick={handleClose2}>
            Save
          </Button>
        </Modal.Footer>
      </Modal>);

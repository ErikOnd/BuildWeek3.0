   ...
   getUser()
    ...
    <Container>
      {show?     <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><small>*Indicates required</small>
        <Form>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Text className="text-muted">
       <h4> Learn more about <a href="">gender pronouns</a>.</h4>
        </Form.Text>
      ...
      <Row className="main">
        ...
        <Col sm={8}>
         <div className="upper">
          ...
          <h6>{user.title}</h6>
          <p>{user.area} • <a href="">Contact Info</a></p>
          <button className="button first" onClick={()=>{setting() }}><b>Open to</b></button>
          <button className="button second"><b>Add Profile</b></button>
          <button className="button third" onClick={()=>{setting2() }}><b>More</b></button>
          {open?
            <div className="open">
              <div className="hover">
              ...
              <p>Showcase services you offer so you and your  business can be found in search</p>
              </div>
            </div>:""}
         {more ?
            <div className="more">
              <div className="hover">
              <p><b>Send Profile in a message</b></p>
              </div>
              <div className="hover">
              <p><b>Save to PDF</b></p>
              </div>
              <div className="hover">
              <p><b>Build a resume</b></p>
              </div>
              <div className="hover">
              <p><b>About this profile</b></p>
              </div>
            </div>
            :""}
         </div>
         ...
         <img className="side " src={user.image} alt="Profile-Pic" />
          <p className="side-text"><b>Epicode</b></p>
          <CameraFill
        className="camera mt-3"
        size={40}
        color="blue"
        />
          <Pencil
         ...
         <div className="suggestions d-flex">
           ...
           <div className="suggestion mx-3 my-5">
            ...
            <p><b>Share that you're hiring</b> and attract qualified candidates</p>
            <a href="">Get Started</a>
           </div>
           <div className="suggestion mx-3 my-5">
      
      <p><b>Showcase services</b> you offer so you and your  business can be found in search</p>
      <a href="">Get Started</a>
     </div>
         </div>

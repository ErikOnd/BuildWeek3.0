...
const HomeRightBar = () => {
  ...
  return (
    <>
      <Container className="home-rigthbar-container py-3">
        <Row>
        ...
        <div className="side-news">
          <p>
            <b>• Why We sleep more in the winter</b>
          </p>
        ...
        <div className="side-news">
          <p>
            <b>• To code, or not to code?</b>
          </p>

          <small>2d ago • 1,698 readers</small>
        </div>
        <div className="side-news">
          <p>
            <b>• Spotify launches 'AI DJ' feature</b>
          </p>
        ...
        <div className="side-news">
          <p>
            <b>• Solving the UK's salad shortage</b>
          </p>

          <small>3d ago • 1,698 readers</small>
        </div>
        {more ? (
          <>
            <div className="side-news">
              <p>
                <b>• When to job hop – and when not to</b>
              </p>

              <small>4d ago • 1,698 readers</small>
            </div>
            <div className="side-news">
              <p>
                <b>• Female-founded firms hit 150k in 2022</b>
              </p>

              <small>5d ago • 1,698 readers</small>
            </div>
            <div className="side-news">
              <p>
                <b>• Supermarkets set bar for 4-day week</b>
              </p>

              <small>6d ago • 1,698 readers</small>
            </div>
            <div className="side-news">
              <p>
                <b>• Secrets to a long and healthy life</b>
              </p>

              <small>1w ago • 1,698 readers</small>
            </div>
            <button onClick={() => setMore(false)} className="ml-4 ">
              {" "}
              Show Less <BsChevronUp />
            </button>
          </>
        ) : (
          <button onClick={() => setMore(true)} className="ml-4 ">
            Show More <BsChevronDown className=" arrowDown" />
          </button>
        )}
      </Container>
      ...
      <Container className="home-rightbar-footer">
        <div className="home-rightbar-footer-links">
          <Row className="d-flex justify-content-center">
            <small>
              <a className="rightbar-link" href="https://about.linkedin.com/">
                About
              </a>
            </small>
            <small>
          ...
          <Row className="d-flex justify-content-center">
            <small>
              <a className="rightbar-link" href="">
                Privacy & Terms <BsChevronDown />{" "}
              </a>
            </small>
            <small>
              <a
          ...
          <Row className="d-flex justify-content-center">
            ...
            <small>
              <a className="rightbar-link" href="">
                Business Services <BsChevronDown />
              </a>{" "}
            </small>
          </Row>
          <Row className="d-flex justify-content-center">
